...
const buttonVariants = cva(
  `
    inline-flex items-center justify-center rounded-md font-cypher font-medium transition-colors
    cursor-pointer
  ...
  `,
  {
    variants: {
      intent: {
        ...
        `,
        buy: `
          bg-trading-bid text-on-trading-bid font-medium
          hover:opacity-90
        `,
        sell: `
          bg-trading-ask text-on-trading-ask font-medium
          hover:opacity-90
        `,
        tonal: `
